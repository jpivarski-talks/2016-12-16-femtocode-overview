...
10 & type propagation & $\surd$ \\
11 & type propagation through other functions & \textcolor{red}{no} \\
12 & typed AST & $\surd$ \\
13 & collate identical expressions & $\surd$ \\
14 & dependencies & $\surd$ \\
\end{tabular}

\column{0.5\linewidth}
\begin{tabular}{r >{\raggedright}p{0.6\linewidth} c}
& step & done? \\\hline
15 & expressions to statements & \textcolor{red}{no} \\
16 & generate intermediate representation & \textcolor{red}{no} \\
17 & simple Numpy implementation & \textcolor{red}{no} \\
18 & focus group syntax, user interface & \textcolor{red}{no} \\
19 & discuss with Philippe & \textcolor{red}{no} \\
20 & start integrating into Terascope & \textcolor{red}{no} \\
21 & implement example of each level-changing function & \textcolor{red}{no} \\
22 & GPU development with Peter Hansen & \textcolor{red}{no} \\
23 & big library of functions & \textcolor{red}{no} \\
24 & regular development & \textcolor{red}{no} \\
\end{tabular}
\end{columns}
\end{frame}
